...
<section>
    <div class="container py-4">
      ...
      <form action="{{ route('auth.projects.store') }}" method="POST">
        @csrf
        ...
        <div class="row flex-wrap mb-2">
            ...
            <div class="col-6 mb-2">
                ...
                <input type="text" class="form-control @error('repository') is-invalid @enderror" id="repository" name="repository" value="{{ old('thumb')}}"/>
                @error('repository')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
